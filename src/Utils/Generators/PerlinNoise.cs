...
namespace project_republics.Utils.Generators;
...
public class PerlinNoise
{
    ...
    private static readonly int[] ReferencePermutation = {
    ...
    public PerlinNoise(int seed = 0)
    {
        ...
        int[] source = (int[])ReferencePermutation.Clone();
