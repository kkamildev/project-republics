...
public class FramedSprite : RotatedSprite
{
    ...
    public FramedSprite(Textures textures, Vector2 position, float ax, float ay, float startingRotation, FrameAnimation animation) : base(textures, position, ax, ay, startingRotation)
    {
