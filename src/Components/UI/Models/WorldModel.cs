...
public class WorldModel : BaseButton
{
    ...
    public static readonly string[] Modes = ["NORMAL_MODE", "SANDBOX_MODE", "PEACEFUL_MODE", "HARDCORE_MODE"];
    public static readonly Color[] ModesColors = [Color.DarkCyan, Color.Orange, Color.Green, Color.DarkRed];
    ...
    public WorldModel(WorldData data, Action onClick, Action onPlay, Action onDelete) : base(onClick)
    {
        ...
        try
        {
            _flag = new(data.FlagPixelRows, new Vector2(7 * 3));
    ...
    public override Vector2 MainPosition {
        ...
        set
        {
            _flag.MainPosition-= base.MainPosition;
